    ...
    <div class="row justify-content-center">
        <div class="col-6">
            ...
            <div class="mb-3">
                ...
                <input id="inputTitle" type="text" value="${board.title}" class="form-control" readonly>
            </div>
            <div class="mb-3">
                <label for="textareaContent" class="form-label">
                    본문
                </label>
                <textarea id="textareaContent" cols="30" rows="10" readonly
            ...
            <div class="mb-3">
                ...
                <input id="inputWriter" type="text" readonly value="${board.writer}" class="form-control">
            </div>
            <div class="mb-3">
